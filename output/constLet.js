...
var nombre = 'Carlos Rafael Arturo';
...
var pi = 3.1416;
console.log('el valor de pi lo ponemos en una variable constante: ' + pi); // scope    -> no se puede acceder a variables fuera de una función, si están creadas en esa función.
...
saludar(); // console.log('variable nombre ' + name);
...
colores.push('Azul');
console.log(colores); // VIDEO5. Curso de ES6 4.- Template Strings
