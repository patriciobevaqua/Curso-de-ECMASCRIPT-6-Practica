...
const amigos= ['Juan', 'Pedro', 'Maria', 'Pablo'];
console.log(amigos);
console.log(amigos,'contiene Pedro:', amigos.includes('Pedro'));
console.log('contiene Pablo:', amigos.includes('Pablo'));
console.log('devuelve el primer elemento del arreglo con longitud mayor a 3:', amigos.find(amigo => amigo.length > 3));
console.log('devuelve Maria si existe :', amigos.find(amigo => amigo==='Maria'));
console.log('devuelve el índice de un elemento:', amigos.findIndex(amigo => amigo==='Maria'));
